...
public class CharacterMotor : MonoBehaviour
{
	...
	private void UpdateFunction()
	{
		...
		if(movingPlatform.enabled && movingPlatform.activePlatform != movingPlatform.hitPlatform)
		{
			...
			//if (inputMoveDirection.x == Mathf.Clamp(inputMoveDirection.x, -90, 90))
			//{
				//GameObject cardboardMain = GameObject.Find("CardboardMain");
				//cardboardMain.transform.position = new Vector3(inputMoveDirection.x, inputMoveDirection.y, inputMoveDirection.z);
			//}
		}
