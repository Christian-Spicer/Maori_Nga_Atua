//this controls the autowalk to stop walking
using UnityEngine;
using System.Collections;

public class AutowalkStopScript : MonoBehaviour {
	//this declares a variable for the head in google cardboard
	private CardboardHead head;
	//this declares the variable for the time it takes to deactivate the autowalk
	...
	void Update() {
		...
		// not looking at object
			...
			Material material = GetComponent<Renderer>().material;
			//this set the color
			material.SetColor("_Color", new Color(255, 0, 0, 0.1f));
			//this line set the delay to count down
			delay = Time.time + delayTime;
		} 
	}
